      ...
      entry: [
        {
          ...
          source: {
            ...
            subtitle: {
              value: '<p><strong>Source Subtitle</strong></p>',
              type: 'xhtml',
            },
      ...
      entry: [
        {
          ...
          updated: '2023-10-02T00:00:00Z',
          content: {
            value: '<widget><part>Hi</part></widget>',
...
describe('Atom compliance validation', () => {
  ...
  test.each([
    [
      'updated',
      (feed: AtomFeedOptions) => {
        feed.updated = '2023-10-01';
      },
    ],
    [
      'entry.0.updated',
      (feed: AtomFeedOptions) => {
        feed.entry[0].updated = '2023-10-01 00:00:00Z';
      },
    ],
    [
      'entry.0.published',
      (feed: AtomFeedOptions) => {
        feed.entry[0].published = '2023-10-01T00:00:00';
      },
    ],
    [
      'entry.0.source.updated',
      (feed: AtomFeedOptions) => {
        feed.entry[0].source!.updated = 'not-a-date';
      },
    ],
      ...
      entry: [
        {
          ...
          link: [
            { href: 'https://example.com/invalid-content', rel: 'alternate' },
          ],
        },
      ],
    });
      ...
      entry: [
        {
          ...
          link: [
            { href: 'https://example.com/direct-author', rel: 'alternate' },
          ],
        },
        {
          ...
          link: [
            { href: 'https://example.com/source-author', rel: 'alternate' },
          ],
        },
      ],
    });
        ...
        entry: [
          {
            ...
            updated: '2023-10-02T00:00:00Z',
            link: [
              { href: 'https://example.com/missing-author', rel: 'alternate' },
            ],
          },
        ],
      });
